...
Given https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/patch/?id=730c5fd42c1e3652a065448fd235cb9fafb2bd10
```diff
...
`find_changes` in `analyze_path.py` return
```json
{
...
Here in [README of GREBE/analyzer](https://github.com/Markakd/GREBE/tree/master/analyzer#step-1-build-kernel-bitcode) we got the answer:
...
I think I've found the great-grandfathers of these pupil analyzers:
 - https://github.com/sslab-gatech/kernel-analyzer
 - https://css.csail.mit.edu/kint/
